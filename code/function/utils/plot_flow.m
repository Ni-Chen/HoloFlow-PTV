function plot_flow(u_ori, scale, map)
    ...
    q = quiver3(x, y, z, u{2}, u{1}, u{3}, uscale, 'linewidth', 1.5);
    ...
    %     set(get(h,'label'),'string','Norm of velocity (pixel/time unit)');
...
%     set(h, 'position', [0.23, 0.86, 0.66, 0.025])
    set(h, 'position', [0.23, 0.75, 0.66, 0.025])
    ...
    %     [x_tick, y_tick, z_tick] = meshgrid(1:udims_ori(2), 1:udims_ori(1), 1:udims_ori(3));
